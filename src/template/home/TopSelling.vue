...
import VerticalImage from '@/assets/img/Vertical.png'
...
export default {
  ...
  mounted() {
    const imageMap = {
      'Vertical.png': VerticalImage,
      'Courage.png': CourageImage,
      'Loose.png': LooseImage,
      'Faded.png': FadedImage,
    }

    this.products = (productsData.topSelling || []).map(product => {
